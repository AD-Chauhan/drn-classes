...
public class CommonValidatorUtil {
	...
	public boolean validateCharForTaskName(String arg) {
		Pattern p = Pattern.compile("^[a-zA-Z_/&\\ \\ ]+$");
		Matcher m = p.matcher(arg);
		return m.matches();
	}
	
	public boolean validateCharForCategoryName(String arg) {
	...
	public boolean validateNumberOnly(String str) {
		...
		Pattern p = Pattern.compile("T-?([0-9]*)"); //T-?([0-9]*) .*[^0-9].*
		Matcher m = p.matcher(str);
	...
	public boolean validateCharNum(String arg) {
