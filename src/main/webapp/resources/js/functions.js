        ...
        initSlick: function(element) {
            ...
            element.each(function() {
                var config = {
                    ...
                    slidesToShow: 4,
                    slidesToScroll: 4,
                    prevArrow: "<button type='button' class='slick-arrow slick-prev pull-left'><i class='flaticon-left-arrow' aria-hidden='true'></i></span><span class='textnav'>Previous</span></button>",
                    nextArrow: "<button type='button' class='slick-arrow slick-next pull-right'><span class='textnav'>Next</span><i class='flaticon-right-arrow-1' aria-hidden='true'></i></button>",
                };
                var slick = $(this);
                if ($(this).data('items')) {
